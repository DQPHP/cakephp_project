...
<html lang="en">
  <head>
    ...
    <!--[if lt IE 9]>
      <script src="/appointment/js/html5shiv.js"></script>
      <script src="/appointment/js/respond.min.js"></script>
    <![endif]-->
  </head>
  <body>
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <a href="../" class="navbar-brand">七联就职</a>
    ...
    <script src="/appointment/js/bootswatch.js"></script>
