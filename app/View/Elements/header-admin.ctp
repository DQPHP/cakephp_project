      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="/appointment/teacher" id="themes">老师管理 <span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a href="/appointment/teacher">查看老师</a></li>
                <li class="divider"></li>
                <li><a href="/appointment/teacher/add">添加老师</a></li>
              </ul>
            </li>
            <li class="dropdown">
